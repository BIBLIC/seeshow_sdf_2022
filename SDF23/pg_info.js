...
const modalCont = [
    ...
    {
        page: 3,
        instruction: "단 한 번 방문해서 지갑 속 운전면허증 그대로 모바일에 넣을 수 있는 모바일 운전면허증, 내용을 확인하고 ‘다음’ 버튼을 눌러주세요."
    },
    {
        page: 4,
        instruction: "언제 어디서나 모바일 신분증으로 신원 증명이 가능합니다. ‘시작하기’버튼을 눌러서 다음으로 진행해 주세요."
    },
    {
        page: 5,
        instruction: "필수 권한은 허용해야만 모바일 신분증 앱 사용이 가능합니다. ‘확인’ 버튼을 눌러주세요. "
    },
    {
        page: 6,
    ...
    {
        page: 16,
        instruction: "확인을 위해 입력한 비밀번호 6자리를 한번 더 입력해 주세요."
    },
    {
        page: 17,
        instruction: "생체 인증을 사용하면 휴대폰에 등록된 지문 등으로 간편하게 인증이 가능합니다. 실습에서는 ‘다음에’ 버튼을 눌러주세요."
    },
    {
        page: 18,
    ...
    {
        page: 19,
        instruction: "모바일 신분증 앱 설치 완료! 발급 방법에는 두 가지가 있습니다. 확인을 위해 ‘다음’ 버튼을 눌러주세요."
    },
    {
        page: 20,
