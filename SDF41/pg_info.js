...
const modalCont = [
    ...
    {
        page: 2,
        instruction: "주민등록번호 앞자리 여섯 글자를 주민번호 입력란의 첫 번째 칸에 입력하세요."
    },
    {
        page: 3,
        instruction: "주민등록번호 뒷자리 일곱 글자를 주민번호 입력란의 두 번째 칸에 입력하세요."
    },
    {
        page: 4,
    ...
    {
        page: 9,
        instruction: "‘인증 전화받기’ 버튼을 클릭하세요."
    },
    {
        page: 10,
        instruction: "비밀번호를 설정하기 위해 먼저 숫자 네 자리를 화면 상의 키패드를 이용해 클릭하세요."
    },
    {
        page: 11,
