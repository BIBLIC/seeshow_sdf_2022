...
const modalCont = [
    ...
    {
        page: 1,
        instruction: "카페앱으로 미리 주문하고 기다림 없이 매장에서 바로 찾는 스마트오더를 실습하겠습니다. 카페앱 첫 화면에서 주문(Order)을 눌러주세요"
    },
    {
        page: 2,
    ...
    {
        page: 7,
        instruction: "매장 정보를 잘 확인하고 선택해주세요. 실습에서는 ‘광화문’ 지점을 눌러주세요."
    },
    {
        page: 8,
    ...
    {
        page: 10,
        instruction: "다시 한 번 주문 지점과 내용을 확인하고 포장 옵션에서 ‘전체 포장’을 찾아서 눌러주세요."
    },
    {
        page: 11,
    ...
    {
        page: 12,
        instruction: "결제 진행을 위해 필수정보에 모두 동의합니다. ‘전체 동의’를 체크해 주세요."
    },
    {
        page: 13,
